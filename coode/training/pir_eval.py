...
class PIRTestRunner():
    def __init__(self,**kwargs):
        ...
        self.normal_weight_milestones = self.conf.get_list('train.normal_weight_milestones', default=[])
    ...
    def run(self):
        ...
        indices, model_input, ground_truth = next(itertools.islice(self.plot_dataloader, idx, None))
        ...
        for s in split:
            ...
            res.append({
                ...
                's1': out['s1'].detach(),
                's2': out['s2'].detach(),
                # 'valid_mask': out['valid_mask'].detach()
            })
